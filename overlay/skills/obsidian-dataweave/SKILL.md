...
description: "KISA's skill: turns Claude Code / Codex into a NotebookLM control panel + .docx import with Zettelkasten atomization + a compiled LLM Wiki layer + FTS5 memory across the whole Obsidian vault. All programmatic, all into your vault, with no external search dependencies."
metadata:
  hermes:
