...
description: "Audit an X account or draft, separate evidence from algorithm folklore, and turn the findings into stronger posts, content ideas, and small measurable experiments. Includes a dated Phoenix ranking reference and a worked @copenzafan case study."
metadata:
  hermes:
    tags: ["x", "twitter", "content", "analytics", "growth", "phoenix", "social-media"]
  deploychan:
    triggers: ["audit my X account", "analyze my Twitter posts", "improve this tweet", "make an X content plan", "why did this post underperform", "find the best time to post on X", "will this image be restricted on X"]
---
# X Content Advisor
