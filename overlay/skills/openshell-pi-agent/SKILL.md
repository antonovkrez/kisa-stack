---
name: openshell-pi-agent
description: "Install and operate Pi inside an OpenShell sandbox with rootless Podman, fail-closed filesystem/network policy, brokered credentials, persistent workspace, pinned inference, reviewed extensions, and evidence-based verification. Includes an optional bidirectional A2A bridge without exposing personal providers or prompts."
metadata:
  hermes:
    tags: ["openshell", "pi", "sandbox", "podman", "isolation", "security", "a2a", "agent"]
  deploychan:
    triggers: ["set up OpenShell and Pi", "isolate a Pi coding agent", "troubleshoot an OpenShell sandbox", "connect an OpenShell agent over A2A"]
